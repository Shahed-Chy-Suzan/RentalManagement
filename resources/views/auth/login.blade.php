            ...
            <div class="row">
                <div class="col-lg-5 offset-lg-1 logreg">
                    <div class="contact_form_container">
                        ...
                        <br><br>
                        <span class="more more2"><a href="" class="btn btn-block text-white bg-transparent button-pipaluk button--inverted" style="font-size: 15px; padding:8px; margin-top:1px"><i class="fab fa-google-plus-square"></i>  Login With Google</a></span>
