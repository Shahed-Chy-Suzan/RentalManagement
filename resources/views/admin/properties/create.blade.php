...
<div class="sl-mainpanel">
    ...
    <a class="breadcrumb-item" href="#">HouseRental</a>
        ...
        <div class="form-layout">
            ...
            <div class="form-row my-3">
                <div class="col-md-4 mb-3 px-3">
                    ...
                    <div class="radio">
                        <label>
                          <input type="radio" name="category" id="Rs1" value="Family">&nbsp; Family
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                ...
                <div class="col-md-4 mb-3 pr-3">
                    ...
                    <div class="radio">
                        <label>
                          <input type="radio" name="type" id="R1" value="Flat">&nbsp; Flat
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                ...
                <div class="col-md-4 mb-3 pr-3">
                    ...
                    <div class="radio">
                        <label>
                          <input type="radio" name="purpose" id="Rads1" value="Sale">&nbsp; Sale
                        </label>
                    </div>
                    <div class="radio">
                        <label>
